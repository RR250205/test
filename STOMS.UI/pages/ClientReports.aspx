<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/mainMaster.Master" CodeBehind="ClientReports.aspx.cs" Inherits="STOMS.UI.pages.ClientReports" %>
    ...
    <div class="row">
        <div class="col-lg-8">
            <h4 class="header headline">
                <asp:Literal ID="ltrListCap" runat="server" Text="Order Trending Report->Top 10 Clients"></asp:Literal></h4>              
        </div>         
            ...
            <div style="float: right !important;">
                ...
                <asp:Label ID="lblStatusValue" runat="server"></asp:Label>&nbsp;<i class="icon-caret-down icon-on-right"></i></button>
                    <ul class="dropdown-menu">
                        <li><a href="javascript:getOrder('O', 'Most Orders','');">Most Orders</a></li>
                        <li><a href="javascript:getOrder('O', 'Latest dates','');">Latest dates</a></li>    
                                                                 
                    </ul>
                </div>
              <%-- <asp:Button ID="btnTopCLients" class="btn btn-primary" Text="Top 10 Clients" runat="server" Visible="true" OnClick="btnTopCLients_Click" />--%>
            </div>
        </div>        
        </div>
 ...
 <div class="row">
        <div class="col-lg-12">
            <telerik:RadGrid ID="tgrdReport" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                BorderColor="#D7D7D7" GridLines="None" Visible="true" PageSize="10" OnItemDataBound="tgrdReport_ItemDataBound">
