<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrgImageUpload.ascx.cs" Inherits="STOMS.UI.usercontrol.OrgImageUpload" %>
        ...
        <div class="row">
            ...
            <div style="margin-right: 20px; margin-bottom: 5px; margin-left: 17px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div onclick="clearPreview()" id="clearPreview" class="fileUpload btn btn-danger" style="border: none">
                            <span>Remove</span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function () {
        $("#<%= flSampleHardCopy.ClientID%>").change(function () {
            ...
            $("#ContentPlaceHolder1_dvViewProImge").hide();
            $("#ContentPlaceHolder1_dvProfileavatar").hide();
            $("#ContentPlaceHolder1_dvProfilePreview").show();
           // $("#dvPreview").show();
            ...
            if (extention == 'jpg' || extention == 'png' || extention == 'jpeg' || extention == 'bmp')
            {
                ...
                alert("Please upload a valid image file.");
                 ...
                 if ($("#ContentPlaceHolder1_dvViewProImge").is(':hidden')) {
                   $("#ContentPlaceHolder1_dvViewProImge").show();
                   $("#ContentPlaceHolder1_dvProfilePreview").hide();
                   $("#ContentPlaceHolder1_dvProfileavatar").hide();
                }
                 else {
                   $("#ContentPlaceHolder1_dvProfilePreview").hide();
                  $("#ContentPlaceHolder1_dvProfileavatar").show();
                      }
    ...
    function clearPreview() {
        ...
        if ($("#ContentPlaceHolder1_dvViewProImge").is(':hidden')) {
            $("#ContentPlaceHolder1_dvViewProImge").show();
            $("#ContentPlaceHolder1_dvProfilePreview").hide();
            $("#ContentPlaceHolder1_dvavatar").hide();
            $("#ContentPlaceHolder1_dvProfileavatar").hide();
